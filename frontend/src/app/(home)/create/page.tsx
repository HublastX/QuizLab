...
export default function CreateQuiz() {
    ...
    const { createQuizFromText, createQuizFromAudio, createQuizFromDocument } =
        useQuiz();
    ...
    const handleFinish = async () => {
        ...
        try {
            ...
            if (themeData?.isNew) {
                ...
                setThemeData((prev) =>
                    prev ? { ...prev, id: themeId, isNew: false } : null
                );
            }
            ...
            if (subtopicData?.isNew) {
                ...
                setSubtopicData((prev) =>
                    prev ? { ...prev, id: subTopicId, isNew: false } : null
                );
            }
                ...
                if (!generatedQuestions) {
                    ...
                    if (response && response.perguntas) {
                        setGeneratedQuestions(
                            convertQuizToQuestions(response.perguntas)
                        );
                    }
                }
