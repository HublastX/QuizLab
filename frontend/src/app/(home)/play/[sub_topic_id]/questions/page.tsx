...
export default function QuestionsPage() {
    ...
    const updateEditingAlternative = (
        index: number,
    ...
    const toggleCorrectAlternative = (index: number) => {
        if (editingQuestion) {
            const newAlternatives = editingQuestion.alternatives.map(
                (alt, i) => ({
                    ...alt,
                    correct: i === index,
                })
        ...
        <div className="p-6 max-w-6xl mx-auto">
            ...
            <div className="space-y-4">
                {questions.map((question, idx) => (
                    <div
                        key={question.id}
                        className="bg-layout-card border rounded-lg p-6"
                    >
                        {editingQuestion?.id === question.id ? (
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-3">
                                    ...
                                    {editingQuestion.alternatives.map(
                                        (alt, altIdx) => (
                                            <div
                                                key={alt.id}
                                                className="bg-layout-card border rounded-lg p-4 space-y-2"
                                            >
